...
func (v *wechatPayValidator) validateHTTPMessage(ctx context.Context, header *protocol.RequestHeader, body []byte) error {
	if v.verifier == nil {
...
func getWechatPayHeader(ctx context.Context, header *protocol.RequestHeader) (wechatPayHeader, error) {
